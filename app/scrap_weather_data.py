...
def scrap_web_data(w_token_url, w_data_url):
    ...
    logger.debug('Token url has been passed - %s', str(w_token_url))
    ...
    # Remove logger debug since got a nexted list with Greek 'alfa' character
    ...
    try:
        ...
        logger.info('Weather list received, %s', str(weather_forecast_time_details))
